...
img_1_median_3 = abstractFilter(img_1, [3 3], @median); titles{3} = 'Median 3x3';
img_1_median_5 = abstractFilter(img_1, [5 5], @median); titles{4} = 'Median 5x5';
img_1_LUM_0 = abstractFilter(img_1, [3 3], @(subImg)filterLUM(subImg, 0)); titles{5} = 'LUM 3x3 k=0';
...
imgs_comp = {img_gray(2:end-2, 2:end-2) img_1(2:end-2, 2:end-2) img_1_median_3(2:end-2, 2:end-2) img_1_median_5(2:end-2, 2:end-2) img_1_LUM_0(2:end-2, 2:end-2) img_1_LUM_4(2:end-2, 2:end-2) img_1_LUM_2(2:end-2, 2:end-2) img_1_LUM_5x5(2:end-2, 2:end-2)};
...
img_1_median_3 = abstractFilter(img_1_RGB, [3 3], @median); titles{3} = 'Median 3x3';
img_1_median_5 = abstractFilter(img_1_RGB, [5 5], @median); titles{4} = 'Median 5x5';
img_1_LUM_0 = abstractFilter(img_1_RGB, [3 3], @(subImg)filterLUM(subImg, 0)); titles{5} = 'LUM 3x3 k=0';
img_1_LUM_4 = abstractFilter(img_1_RGB, [3 3], @(subImg)filterLUM(subImg, 4)); titles{6} = 'LUM 3x3 k=4';
img_1_LUM_2 = abstractFilter(img_1_RGB, [3 3], @(subImg)filterLUM(subImg, 2)); titles{7} = 'LUM 3x3 k=2';
img_1_LUM_5x5 = abstractFilter(img_1_RGB, [5 5], @(subImg)filterLUM(subImg, 3)); titles{8} = 'LUM 5x5 k=3';

imgs_comp = {img(2:end-2, 2:end-2) img_1_RGB(2:end-2, 2:end-2) img_1_median_3(2:end-2, 2:end-2) img_1_median_5(2:end-2, 2:end-2) img_1_LUM_0(2:end-2, 2:end-2) img_1_LUM_4(2:end-2, 2:end-2) img_1_LUM_2(2:end-2, 2:end-2) img_1_LUM_5x5(2:end-2, 2:end-2)};
titles = appendPSNR(imgs_comp, titles);
show_results(imgs_comp, titles);
